  ...
  return (
    <div style={styles.page}>
      ...
      <div style={{background:'rgba(10,13,20,0.98)',borderBottom:'1px solid rgba(255,255,255,0.05)',padding:'0.875rem 1.5rem',display:'flex',justifyContent:'space-between',alignItems:'center',position:'sticky',top:0,zIndex:100,backdropFilter:'blur(16px)'}}>
        <a href="/dashboard" style={{fontSize:'13px',color:'#5a5f72',textDecoration:'none',display:'flex',alignItems:'center',gap:'6px'}}>
          ← Dashboard
        </a>
      ...
      <div style={{maxWidth:'760px',margin:'0 auto',padding:'2.5rem 1.5rem'}}>
        ...
        <div style={{...styles.card, marginBottom:'1.5rem'}}>
          ...
          <div style={{borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:'16px'}}>
            ...
            <label style={styles.label}>Recent comparable sales — paste any comp data you have</label>
            ...
            <label style={styles.label}>Additional notes for the AI</label>
            <textarea placeholder="Seller expects $1.2M, market has been slow, corner lot, busy street..." value={form.notes} onChange={e => setForm({...form, notes: e.target.value})}
