      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '2rem 1.5rem', position: 'relative', zIndex: 1 }}>
        ...
        <div id="rescue-form" style={{ ...cardStyle, border: '1px solid rgba(239,68,68,0.18)', boxShadow: '0 4px 32px rgba(239,68,68,0.08)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '14px' }}>
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setForm({ ...form, daysOnMarket: e.target.value })}
                style={inputStyle}
              />
            </div>
          </div>
          ...
          <div style={{ marginBottom: '14px' }}>
            ...
            <input
              type="text"
              placeholder="e.g. $549,000 (if price was reduced)"
              value={form.originalListPrice}
              onChange={e => setForm({ ...form, originalListPrice: e.target.value })}
              style={inputStyle}
            />
          </div>
