  ...
  return (
    <main style={{fontFamily:'sans-serif',color:'#111'}}>
      ...
      <section style={{textAlign:'center',padding:'5rem 2rem 3rem',background:'linear-gradient(180deg,#f0fdf8 0%,#fff 100%)'}}>
        <div style={{display:'inline-block',background:'#E1F5EE',color:'#085041',fontSize:'12px',fontWeight:'600',padding:'4px 12px',borderRadius:'20px',marginBottom:'1rem',letterSpacing:'0.5px'}}>
          BUILT FOR REAL ESTATE AGENTS
        </div>
        <h1 style={{fontSize:'3rem',fontWeight:'700',lineHeight:'1.2',marginBottom:'1.5rem',maxWidth:'700px',margin:'0 auto 1.5rem'}}>
          Stop spending hours writing<br/><span style={{color:'#1D9E75'}}>listing copy.</span>
        </h1>
        <p style={{fontSize:'1.125rem',color:'#555',maxWidth:'520px',margin:'0 auto 2rem',lineHeight:'1.7'}}>
          Paste in your property notes and get polished MLS descriptions, Instagram captions, email blasts, open house flyers, and more — in seconds.
        </p>
        ...
        <p style={{fontSize:'13px',color:'#999'}}>3 free listings · No credit card required · Cancel anytime</p>
      </section>
      ...
      <section style={{padding:'4rem 2rem',maxWidth:'900px',margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr auto 1fr',gap:'1rem',alignItems:'center'}}>
          <div style={{background:'#fff8f0',border:'1px solid #fde8c8',borderRadius:'12px',padding:'1.5rem'}}>
            <p style={{fontSize:'11px',fontWeight:'700',color:'#999',marginBottom:'8px',letterSpacing:'1px'}}>YOUR NOTES</p>
          ...
          <div style={{background:'#f0fdf8',border:'1px solid #bbf0d9',borderRadius:'12px',padding:'1.5rem'}}>
            ...
            <p style={{fontSize:'13px',color:'#333',lineHeight:'1.8'}}>✅ MLS Description<br/>✅ Instagram Caption<br/>✅ Facebook Post<br/>✅ Email Blast<br/>✅ Open House Flyer<br/>✅ Video Script<br/>✅ Luxury MLS<br/>✅ SEO Copy</p>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" style={{padding:'4rem 2rem',background:'#f9fafb'}}>
        <div style={{maxWidth:'800px',margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'2rem'}}>
            {[
              {step:'1',title:'Enter your property details',desc:'Fill in the basics — type, beds, price, neighborhood, features, and tone.'},
              {step:'2',title:'Click Generate',desc:'Our AI writes 8 formats of marketing copy tailored to your property and target buyer.'},
              {step:'3',title:'Copy, paste, done',desc:'Use the MLS copy, Instagram caption, email blast, and more — all in one click.'},
            ].map(({step,title,desc}) => (
      ...
      <section id="examples" style={{padding:'4rem 2rem',maxWidth:'800px',margin:'0 auto'}}>
        ...
        <p style={{textAlign:'center',color:'#666',marginBottom:'2rem'}}>Here's what Listing Whisperer generates from a single set of notes.</p>
        <SampleOutputs />
      </section>
      ...
      <section style={{padding:'4rem 2rem',background:'#f9fafb'}}>
        <div style={{maxWidth:'700px',margin:'0 auto',textAlign:'center'}}>
          <h2 style={{fontSize:'1.75rem',fontWeight:'600',marginBottom:'0.5rem'}}>Why not just use ChatGPT?</h2>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1.5rem',textAlign:'left'}}>
            <div style={{background:'#fff',borderRadius:'12px',padding:'1.5rem',border:'1px solid #eee'}}>
              <p style={{fontWeight:'600',marginBottom:'1rem',color:'#999'}}>❌ Generic AI (ChatGPT)</p>
      ...
      <footer style={{padding:'2rem',textAlign:'center',borderTop:'1px solid #eee',background:'#fff'}}>
        <p style={{fontSize:'13px',color:'#999'}}>© 2025 Listing Whisperer · <a href="/login" style={{color:'#999'}}>Sign In</a> · <a href="/signup" style={{color:'#999'}}>Get Started</a></p>
      </footer>
