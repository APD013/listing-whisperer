...
function PrintContent() {
  ...
  useEffect(() => {
    ...
    supabase.from('listing_presentations').select('*').eq('id', id).single().then(({ data }) => {
  ...
  const sections = [
    { label: 'Opening Statement', content: o.openingStatement },
    { label: 'Marketing Plan', content: o.marketingPlan },
    { label: 'Why List With Me', content: o.whyListWithMe },
    { label: 'Pricing Strategy', content: o.pricingStrategy },
    { label: 'Objection Responses', content: o.objectionHandling },
    { label: 'Closing Script', content: o.closingScript },
    { label: 'Follow-Up Plan', content: o.followUpPlan },
  ]
    ...
    <div style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', maxWidth: '760px', margin: '0 auto', padding: '24px 20px', color: '#1a1a2e', background: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid #1D9E75', paddingBottom: '12px', marginBottom: '24px' }}>
        <div style={{ flexShrink: 0 }}>
          ...
          <div style={{ fontSize: '10px', color: '#718096', marginTop: '2px', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif' }}>Listing Presentation Kit</div>
        </div>
...
export default function PrintListingPresentation() {
