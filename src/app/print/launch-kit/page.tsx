...
function PrintContent() {
  ...
  useEffect(() => {
    ...
    supabase.from('launch_kits').select('*').eq('id', id).single().then(({ data }) => {
  ...
  const sections = [
    { label: 'Day 1 — Launch Day', content: o.day1 },
    { label: 'Day 2 — Follow Up', content: o.day2 },
    { label: 'Day 3 — Mid Week', content: o.day3 },
    { label: 'Day 4 — Spotlight', content: o.day4 },
    { label: 'Day 5 — Open House', content: o.day5 },
    { label: 'Day 6 — Weekend', content: o.day6 },
    { label: 'Day 7 — Final Push', content: o.day7 },
    { label: 'Email Sequence', content: o.email_sequence },
    { label: 'Social Calendar', content: o.social_calendar },
    { label: 'Pro Tips', content: o.pro_tips },
  ]
    ...
    <div style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', maxWidth: '760px', margin: '0 auto', padding: '24px 20px', color: '#1a1a2e', background: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid #1D9E75', paddingBottom: '12px', marginBottom: '24px' }}>
        <div style={{ flexShrink: 0 }}>
          ...
          <div style={{ fontSize: '10px', color: '#718096', marginTop: '2px', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif' }}>7-Day Launch Kit</div>
        </div>
...
export default function PrintLaunchKit() {
