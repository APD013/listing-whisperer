...
function PrintContent() {
  ...
  useEffect(() => {
    ...
    supabase.from('buyer_consultations').select('*').eq('id', id).single().then(({ data }) => {
  ...
  const sections = [
    { label: 'Meeting Outline', content: o.consultation_outline },
    { label: 'Questions to Ask', content: o.questions_to_ask },
    { label: 'Needs Assessment', content: o.needs_assessment },
    { label: 'Financing Talk', content: o.financing_talking_points },
    { label: 'Search Strategy', content: o.property_search_strategy },
    ...
    <div style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', maxWidth: '760px', margin: '0 auto', padding: '24px 20px', color: '#1a1a2e', background: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid #1D9E75', paddingBottom: '12px', marginBottom: '24px' }}>
        <div style={{ flexShrink: 0 }}>
          ...
          <div style={{ fontSize: '10px', color: '#718096', marginTop: '2px', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif' }}>Buyer Consultation Kit</div>
        </div>
...
export default function PrintBuyerConsultation() {
