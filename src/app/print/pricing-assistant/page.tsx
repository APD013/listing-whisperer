...
function PrintContent() {
  ...
  useEffect(() => {
    ...
    supabase.from('pricing_reports_history').select('*').eq('id', id).single().then(({ data }) => {
  ...
  const priceSection = o.priceRange ? `Suggested List Price: ${o.priceRange}\n${o.confidence || ''}` : ''
  const sections = [
    { label: 'Suggested Price Range', content: priceSection },
    { label: 'Pricing Strategy', content: o.strategy },
    { label: 'Seller Talking Points', content: o.sellerTalkingPoints },
    { label: 'Key Pricing Factors', content: o.keyFactors },
    { label: 'Objection Responses', content: o.objectionResponses },
    { label: 'Market Positioning', content: o.marketPositioning },
  ]
    ...
    <div style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', maxWidth: '760px', margin: '0 auto', padding: '24px 20px', color: '#1a1a2e', background: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid #1D9E75', paddingBottom: '12px', marginBottom: '24px' }}>
        <div style={{ flexShrink: 0 }}>
          ...
          <div style={{ fontSize: '10px', color: '#718096', marginTop: '2px', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif' }}>Pricing Strategy Report</div>
        </div>
...
export default function PrintPricingAssistant() {
