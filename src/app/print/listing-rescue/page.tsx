...
function PrintContent() {
  ...
  useEffect(() => {
    ...
    supabase.from('listing_rescues_history').select('*').eq('id', id).single().then(({ data }) => {
  ...
  const sections = [
    { label: 'Root Cause Diagnosis', content: o.root_cause },
    { label: 'Ideal Buyer Profile', content: o.buyer_profile },
    { label: 'Repositioning Strategy', content: o.repositioning_strategy },
    { label: 'New Listing Copy', content: o.new_listing_copy },
    { label: 'Content Strategy', content: o.content_strategy },
    { label: 'Price & Offer Strategy', content: o.price_offer_strategy },
  ]
    ...
    <div style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', maxWidth: '760px', margin: '0 auto', padding: '24px 20px', color: '#1a1a2e', background: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid #1D9E75', paddingBottom: '12px', marginBottom: '24px' }}>
        <div style={{ flexShrink: 0 }}>
          ...
          <div style={{ fontSize: '10px', color: '#718096', marginTop: '2px', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif' }}>Listing Rescue Plan</div>
        </div>
...
export default function PrintListingRescue() {
